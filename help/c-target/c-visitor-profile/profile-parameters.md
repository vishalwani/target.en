...
* The parameter remains in the profile after disabling the script, and therefore, users whose profiles already contain a parameter that is used in an Activity's Audience will qualify in that activity.
