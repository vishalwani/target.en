...
|Date|Topic|Changes|
| --- | --- | --- |
|June 15|[Target release notes (prerelease)](/help/r-release-notes/target-release-notes.md)|Updated the notes for the [!DNL Target Standard/Premium] 20.5.1 release (June 17, 2020) to include information about A4T support in [!DNL Analysis Workspace].|
