...
||[Auto-Allocate](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md)|Added the following FAQs:<ul><li>Can I use the Reset Report Data option while running an Auto-Allocate activity?</li><li>How does Auto-Allocate build models with regards to environments?</li></ul>|
||[Auto-Target](/help/c-activities/auto-target-to-optimize.md)|Added the following FAQ:<ul><li>Can I use the Reset Report Data option while running an Auto-Target activity?</li></ul>|
||[Automated Personalization FAQs](/help/c-activities/t-automated-personalization/automated-personalization-faq.md)|Added the following FAQ:<ul><li>Can I use the Reset Report Data option while running an Automated Personalization activity?</li></ul>|
