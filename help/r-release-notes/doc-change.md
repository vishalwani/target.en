...
## Adobe Target Standard/Premium 20.7.1 (July 23, 2020)

|Date|Topic|Changes|
| --- | --- | --- |
|July 22|[Administer Target](/help/administrating-target/administrating-target.md)|Updated text in all linked topics on this page to reflect the new UI changes for the [!UICONTROL Administration] pages.|
