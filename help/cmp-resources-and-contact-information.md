...
|--- |--- |
|[at.js tips and overview](https://helpx.adobe.com/customer-care-office-hours/target/at-js-1x-Tips-and-Overview.html)<br>59:12<br>June 26, 2019|Tyou will learn:<ul><li>Benefits of using at.js</li><li>at.js settings</li><li>Flicker handling</li><li>Debugging at.js</li><li>Known issues</li><li>FAQ</li></ul>For more information, see [How at.js works](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-how-atjs-works/how-atjs-works.md).|
|[Target Premium Workspaces](https://helpx.adobe.com/customer-care-office-hours/target/premium-workspaces.html)<br>27:49<br>September 4, 2018|You will learn:<ul><li>Creating a workspace (product profile)</li><li>Creating properties</li><li>Adding users</li><li>Updating implementation</li></ul>For more information, see [Enterprise user permissions](/help/administrating-target/c-user-management/property-channel/property-channel.md).|
